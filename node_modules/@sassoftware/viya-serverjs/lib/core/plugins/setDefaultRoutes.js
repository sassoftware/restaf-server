...
module.exports = function setDefaultRoutes(server, options) {
  ...
  function preResponse(req, h) {
    console.log('in preResponse', h.request.auth);
    req["continue"]();
  }
  var defaultTable = [{
    method: ['GET'],
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                console.log('app authentication state:', req.auth.isAuthenticated);
                if (req.auth.isAuthenticated) {
                  _context2.next = 4;
                  break;
                }
                return _context2.abrupt("return", "Authentication failed due to: ".concat(req.auth.error.message));
              case 4:
                _context2.next = 6;
                return getAppb(req, h);
              case 6:
                r = _context2.sent;
                console.log('response from getApp', r);
                if (!(r.target === "redirect")) {
                  _context2.next = 12;
                  break;
                }
                return _context2.abrupt("return", h.redirect(r.redirect));
              case 12:
                console.log('--------------------------------');
                console.log(h.request.auth);
                console.log('--------------------------------');
                console.log('response from getApp', r);
                return _context2.abrupt("return", h.file(r.redirect));
              case 17:
              case "end":
          ...
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                ...
                console.log('in logon handler');
                _context4.next = 4;
                return (0, _handlers.logon)(req, h, options);
              case 4:
                r = _context4.sent;
                
                return _context4.abrupt("return", h.redirect(r.redirect));
              case 7:
              case "end":
