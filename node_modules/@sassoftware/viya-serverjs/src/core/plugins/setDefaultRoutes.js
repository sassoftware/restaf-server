...
module.exports = function setDefaultRoutes (server, options) {
	...
	//let getAppb = getApp.bind(null, options);
  ...
  options.authLogon   = authLogon;
	...
	/*
	Not enabled but here for reference
	...
	let defaultTable = [
		...
		},
		{
			...
			options: {
				...
				handler: async (req,h) => getApp(req,h, options),
		}
	},
		{
			method : ['GET'],
		...
		},
		{
			...
			options: {
				...
				handler: async (req,h) => logon(req,h, options)
		...
		},
		{
			...
			options: {
				auth   : authDefault,
				handler: (req,h) => appCallback(req,h, options),
			},
		},
		{
			method : ['GET'],
		...
		},
		{
			...
			options: {
				auth   : authLogon, /*authDefault,*/
				handler: (req,h) => getApp2(req,h, options),
			},
		},
		{
			method: ['GET'],
