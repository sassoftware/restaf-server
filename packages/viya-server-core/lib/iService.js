 ...
 *
 */
let fs = require('fs'); // let isDocker = require('is-docker');
...
let inert = require('@hapi/inert'); // let HapiSwagger = require('hapi-swagger');
...
`);
    ...
    */
    ...
    let msg = options.serverMode === 'app' ? `Visit ${hh}/${process.env.APPNAME} to access application` : `Visit ${hh}/${process.env.APPNAME}/api to access swagger`;
    console.log(msg);
...
async function getTls() {
  ...
  {
    type: 6,
    value: `https://${process.env.APPHOST}:${process.env.APPPORT}/${process.env.APPNAME}`
  }, {
    type: 6,
    value: `https://${process.env.APPHOST}:${process.env.APPPORT}/${process.env.APPNAME}/api`
  }, {
    type: 6,
    value: `https://${process.env.APPHOST}:${process.env.APPPORT}/${process.env.APPNAME}/logon`
  }, {
    type: 6,
    value: `https://${process.env.APPHOST}/${process.env.APPNAME}`
  }, {
    type: 6,
    value: `https://${process.env.APPHOST}/${process.env.APPNAME}/api`
  }, {
    type: 6,
    value: `https://${process.env.APPHOST}/${process.env.APPNAME}/logon`
  }];
