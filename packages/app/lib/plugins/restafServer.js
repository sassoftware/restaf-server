...
let SASauth = require('./SASauth'); //  WebpackPlugin = require('hapi-webpack-plugin'),/* for hot restart */
...
async function appServer(server, options) {
  ...
  await server.register([inert, vision]); // use hapi's builtin cookie management
