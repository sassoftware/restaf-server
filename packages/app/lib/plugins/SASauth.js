...
function _iSASauth() {
  _iSASauth = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(hapiServer, options) {
    var bellAuthOptions, provider, authURL;
          ...
          case 0:
            ...
            bellAuthOptions = {
              ...
              location: function location() {
                debug("Redirect set to: ".concat(process.env.REDIRECT));
