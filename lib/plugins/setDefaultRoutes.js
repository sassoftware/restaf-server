...
module.exports = function setDefaultRoutes(server, options) {
  ...
  var defaultTable = [{
    ...
    options: {
      ...
      handler: function () {
        var _handler3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, h) {
    ...
    options: {
      auth: /*authDefault*/false,
      handler: function () {
        var _handler4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, h) {
          var allAppEnv, uappenv, s;
  ...
  */

  {
    ...
    options: {
      auth: authDefault,
      handler: function () {
        var _handler5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, h) {
          return _regeneratorRuntime().wrap(function _callee5$(_context5) {
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>in param');
                return _context5.abrupt("return", (0, _handlers.getApp2)(req, h));
              case 2:
              case "end":
