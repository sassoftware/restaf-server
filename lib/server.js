...
var _SASauthold = _interopRequireDefault(require("./SASauthold"));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return (0, _SASauthold["default"])(hapiServer);
            ...
            case 11:
              if (isDocker() === false) {
                ...
                if (process.env.APPHOST === '0.0.0.0') {
                  console.log("To access application visit http://localhost:".concat(process.env.APPPORT, "/").concat(process.env.APPNAME));
                } else {
                ...
                console.log('Please replace the port in the url above with the port number it was mapped to.');
              }
