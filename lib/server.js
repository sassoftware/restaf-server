  ...
  */
  ...
  var init = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      var visionOptions, _options, swaggerOptions, js, preResponse, hh;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 24:
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          ...
                          debug(req);
                          output = req.response.output.payload != null ? JSON.stringify(req.response.output.payload, null, 4) : ' ';
              ...
              hapiServer.ext('onPreResponse', preResponse); // Finally setup routes and start server
              // temp:
