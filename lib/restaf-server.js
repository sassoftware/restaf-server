...
var request = __webpack_require__(2).defaults({
    jar: true
}),
    bell = __webpack_require__(13),
...
var iService = __webpack_require__(9);
...
function serverInfo(req, reply) {
    debugger;
    var protocol = process.env.SAS_SSL_ENABLED === 'YES' ? 'https://' : 'http://';
    var js = 'let VIYA_HOST   = "' + protocol + process.env.VIYA_SERVER + '";';
    reply.response(js);
}
...
var Hapi = __webpack_require__(11),
    inert = __webpack_require__(12),
    SASauth = __webpack_require__(1),
