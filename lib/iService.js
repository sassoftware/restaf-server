...
function iService(uTablep, useDefault, asset, allAppEnv) {
  ...
  var uTable = typeof uTablep === 'function' ? uTablep() : uTablep;
  ...
  var defaultTable = [{
    ...
    config: {
      auth: auth2,
      handler: function () {
        var _handler2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(req, h) {
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  return _context3.abrupt("return", "Logon failed with ".concat(JSON.stringify(req.auth.error, null, 4)));
...
function getIcon(_x7, _x8) {
  return _getIcon.apply(this, arguments);
}

function _getIcon() {
  _getIcon = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, h) {
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", h.file('favicon.ico'));
...
function getApp2(_x9, _x10) {
  return _getApp.apply(this, arguments);
}

function _getApp() {
  _getApp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, h) {
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt("return", h.file("".concat(req.params.param)));
...
function _getFiles() {
  _getFiles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, h) {
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt("return", 'not ready for primetime');
