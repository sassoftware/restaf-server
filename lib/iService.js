...
var debug = require('debug'); // let debugSetup     = debug('setup');
...
function iService(uTable, useDefault, asset, allAppEnv) {
  ...
  var defaultTable = [{
    ...
    config: {
      ...
      notes: ['Invoke this end point to start your application', 'Will redirect to asset named in APPENTRY', 'If logging on with authentication make sure you have set the following in the configuration files', 'VIYA_SERVER to your Viya Server url', 'AUTHFLOW to implicit or authorization_code', 'CLIENTID to your client ID', 'CLIENTSECRET if you are using authorization_code', 'APPENTRY to the apps main html'],
...
function getIcon(_x3, _x4) {
  return _getIcon.apply(this, arguments);
}

function _getIcon() {
  _getIcon = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, h) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", h.file('favicon.ico'));
...
function getApp2(_x5, _x6) {
  return _getApp.apply(this, arguments);
}

function _getApp() {
  _getApp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(req, h) {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", h.file("".concat(req.params.param)));
...
function getFiles(_x7, _x8) {
  return _getFiles.apply(this, arguments);
}

function _getFiles() {
  _getFiles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, h) {
    var r;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            r = h.file("".concat(req.params.param)).header('content-type', 'binary/octet-stream');
