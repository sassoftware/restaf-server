...
function appServerV(userRouterTable, asset, rootHandler) {
  ...
  var init = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var info, swaggerOptions, plugin;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              _context.next = 11;
              return hapiServer.register(plugin, {
                routes: {
            ...
            case 14:
              console.log("http://".concat(process.env.VHOST, "/").concat(process.env.APPNAME));
...
function pluginRegister(_x, _x2) {
  return _pluginRegister.apply(this, arguments);
}

function _pluginRegister() {
  _pluginRegister = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(server, options) {
