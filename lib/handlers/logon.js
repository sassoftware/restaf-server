...
var _codeAuth = _interopRequireDefault(require("./codeAuth.js"));
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          r = (0, _codeAuth["default"])(req, h, options); // r = await setCookies(req, h, options);
          debug(r.redirect);
...
var _default = exports["default"] = logon;