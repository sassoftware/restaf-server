    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            SASLogon = "".concat(process.env.VIYA_SERVER, "/SASLogon/oauth/authorize?client_id=").concat(process.env.CLIENTID, "&redirect_uri=").concat(process.env.APPSERVER, "/keepAlive2");
            debug(SASLogon);
