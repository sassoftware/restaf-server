    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          return _context.a(2, h.redirect(SASLogon).code(302));
      }
    }, _callee);
  }));
  return _keepAlive.apply(this, arguments);
...
function _refreshToken() {
  _refreshToken = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, h) {
    var credentials, sid, config, r, newcred, error, _t;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 3:
          return _context2.a(2, credentials);
        case 4:
          _context2.p = 4;
          _t = _context2.v;
          error = Boom.badRequest('Unable to refresh tokens in KeepAlive', JSON.stringify(_t, null, 4));
          throw error;
        case 5:
