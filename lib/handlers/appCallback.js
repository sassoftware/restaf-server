...
function _appCallback() {
  _appCallback = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, h) {
    var indexHTML;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          return _context.a(2, (0, _codeAuth["default"])(req, h));
        case 1:
          ...
          return _context.a(2, h.file("".concat(indexHTML)));
        case 2:
          return _context.a(2);
      }
    }, _callee);
