...
var debug = require('debug')('logoff');

function logoff(_x, _x2) {
  return _logoff.apply(this, arguments);
}

function _logoff() {
  _logoff = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, h) {
    var credentials, sid;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            debug(req.state);
            return _context.abrupt("return", h.response('Server session cleared').unstate('authCookie'));
