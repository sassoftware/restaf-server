      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", '<h2> SAS Logon failed to return token. Probably related to some combination of server settings an browser settings</h2><h2> Contact your administrator</h2>');
