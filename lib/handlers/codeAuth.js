      ...
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          if (process.env.REDIRECT != null) {
            redirectPath = true;
            indexHTML = process.env.REDIRECT != null && process.env.REDIRECT.startsWith('/') ? "/".concat(process.env.APPNAME).concat(process.env.REDIRECT) : "/".concat(process.env.REDIRECT);
          }
          if (!redirectPath) {
            _context.n = 2;
            break;
