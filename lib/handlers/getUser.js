...
function _getUser() {
  _getUser = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, h) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          debug(name);
          return _context.a(2, "let USER_NAME='".concat(name, "'"));
      }
    }, _callee);
  }));
  return _getUser.apply(this, arguments);
}
var _default = exports["default"] = getUser;