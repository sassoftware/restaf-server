      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            indexHTML = process.env.APPENTRY == null ? 'index.html' : process.env.APPENTRY; // return h.file(`${indexHTML}`);

            return _context2.abrupt("return", h.response().redirect('/reDirector'));
