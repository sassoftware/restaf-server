...
function _logout() {
  _logout = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, h) {
    var q, credentials, sid, hh, callbackUrl, url, _hh, _callbackUrl;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 22:
            _hh = req.server.info.uri.replace(/0.0.0.0/, 'localhost');
            _callbackUrl = "".concat(_hh, "/").concat(process.env.APPNAME, "/").concat(q.callbackUrl);
