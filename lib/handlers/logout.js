...
function _logout() {
  _logout = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, h) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 3:
          return _context.a(2, h.redirect(url).unstate('ocookie'));
      }
    }, _callee);
  }));
  return _logout.apply(this, arguments);
...
function _ViyaLogout() {
  _ViyaLogout = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var p, r;
